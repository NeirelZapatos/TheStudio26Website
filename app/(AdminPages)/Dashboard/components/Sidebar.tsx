              ...
              {showCoursesAndItems && (
                <div className="pl-8 space-y-1 mt-1">
                  <button
                    ...
                    className={`flex items-center w-full text-left p-2 rounded-lg ${activeSection === "courseList"
                      ? "bg-gray-700"
                      : "hover:bg-gray-600"
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center w-full text-left p-2 rounded-lg ${activeSection === "itemList"
                      ? "bg-gray-700"
                      : "hover:bg-gray-600"
                      }`}
                  >
