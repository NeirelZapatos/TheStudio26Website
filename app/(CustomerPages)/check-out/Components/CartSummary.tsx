      ...
      <div className="grid md:grid-cols-3 gap-10 mt-8">
        ...
        <div className="bg-white rounded-md px-4 py-6 h-max shadow-[0_2px_12px_-3px_rgba(61,63,68,0.3)]">
          <ul className="text-slate-900 font-medium space-y-4">
            <li className="flex flex-wrap gap-4 text-xl font-semibold">Subtotal <span className="ml-auto">${subtotal.toFixed(2)}</span></li>
          </ul>
          ...
          <div className="mt-8 space-y-2">
            ...
            <Link
              href="/StoreSearch"
              className="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-transparent hover:bg-slate-100 text-slate-900 border border-slate-300 rounded-md inline-block text-center"
            >
              Continue Shopping
            </Link>
          </div>
