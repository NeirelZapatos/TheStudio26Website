...
const Page = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4">
      ...
      <h1 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 sm:mb-6">Book Your Lab</h1>
              ...
              <div className="mt-8">
                ...
                {selectedLab && (
                  <div className="mt-4">
                    ...
                    <button
                      className="w-full py-2 sm:py-3 px-4 bg-blue-600 text-white text-sm sm:text-base rounded-md hover:bg-blue-700"
            ...
            {selectedLab && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="mt-4">
                        ...
                        <div className="space-y-2 mt-2">
                          {rentalEquipment.map((item) => (
                            <div
                              key={item._id}
                              className="p-2 sm:p-3 border rounded hover:bg-gray-50"
                            >
                ...
                <div className="md:col-span-1">
                  <div className="bg-white rounded-md px-4 py-6 shadow-[0_2px_12px_-3px_rgba(61,63,68,0.3)] md:sticky md:top-4">
